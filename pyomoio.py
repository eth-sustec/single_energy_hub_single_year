# -*- coding: utf-8 -*-
"""
Script for easy output of results from a Pyomo Concrete model

Developed as part of the urbs linear programming model from TUM's Chair of Renewable 
and Sustainable Energy Systems

Code source: https://github.com/tum-ens/urbs/blob/master/urbs/pyomoio.py

Project source: https://github.com/tum-ens/urbs
"""
